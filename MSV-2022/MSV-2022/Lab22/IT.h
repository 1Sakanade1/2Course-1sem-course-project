...
#define TI_PARMSIZE     10					// максимальное количество передаваемых в функцию параметров

#define PARM_ID L".id.txt"

namespace IT
{
	enum IDDATATYPE { DEF = 0, INT = 1, STR = 2,VAC = 3 };				// типы данных идентификаторов: integer, string, vacuum
	...
	struct Entry
	{
		...
		int parmQuantity;
		int parmtype[TI_PARMSIZE] = { IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF,IDDATATYPE::DEF };
		Entry();
