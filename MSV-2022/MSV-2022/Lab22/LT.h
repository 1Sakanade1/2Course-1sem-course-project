...
#define LEX_ECHO		'w'			// лексема для while
#define LEX_CONCATSTR   'c'			// лексема для concatstr
#define LEX_COPYSTR		'C'			// лексема для copystr
#define LEX_VACUUM		't'			// лексема для процедур
